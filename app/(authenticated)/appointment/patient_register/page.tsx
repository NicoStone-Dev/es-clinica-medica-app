...
export default function PatientRegister() {
  ...
  async function carregarPacientes() {
    ...
    try {
      ...
      setErro(e instanceof ApiError ? e.message : "Erro ao carregar pacientes.");
    } finally {
      setCarregando(false);
    }
  }
  ...
  function atualizarCampo(campo: keyof Omit<NovoPaciente, "endereco">, valor: string) {
    setForm((prev) => ({ ...prev, [campo]: valor }));
  }

  function atualizarEndereco(campo: keyof NovoPaciente["endereco"], valor: string) {
  ...
  async function handleSalvar() {
    ...
    try {
      ...
      setErro(e instanceof ApiError ? e.message : "Erro ao cadastrar paciente.");
    } finally {
      setSalvando(false);
    }
  }
            ...
            <div className="flex flex-row gap-4">
              ...
              <div className="flex flex-col w-full justify-center">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    atualizarEndereco("numero", e.target.value.replace(/\D/g, ""))
                  }
                />
              </div>
            </div>
